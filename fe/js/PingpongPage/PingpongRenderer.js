...
class PingpongRenderer {
  ...
  _setGameSizeInfo() {
    ...
    this.paddleHeightPercent =
      (this.clientInfo.gameInfo.sizeInfo.paddleHeight / this.boardHeight) * 100;
    this.paddleWidthPercent =
      (this.clientInfo.gameInfo.sizeInfo.paddleWidth / this.boardWidth) * 100;
