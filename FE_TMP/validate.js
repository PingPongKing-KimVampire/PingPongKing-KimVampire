...
const passwordConfirmWarning = document.querySelector("#passwordConfirmWarning");
...
function checkPassword() {
	...
	if (!validatePassword(password)) {
		const invalidPasswordMessage = "8에서 20자의 영문, 숫자, 1개 이상의 특수문자만 사용 가능합니다.";
...
function updateConfirmButton() {
	if (usernameValidState && passwordValidState && passwordConfirmValidState && nicknameValidState) {
