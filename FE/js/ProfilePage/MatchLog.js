	...
	return `
        <div class="matchLog" data-id="${gameHistory.gameId}">
            ...
            <div class="matchScoreContainer">
                <img class="matchResultImage" src="images/${gameHistory.result?.toLowerCase()}Icon.png">
            ...
            <div class="matchTeamListContainer">
                <div class="matchTeamContainer">
                    ${gameHistory.ability[0] !== "none" ? "<img class='leftAbilityImage' src='images/ability/" + gameHistory.ability[0] + ".png'>" : "<div></div>"}
                ...
                <div class="matchTeamContainer">
                    ...
                    ${gameHistory.ability[1] !== "none" ? "<img class='rightAbilityImage' src='images/ability/" + gameHistory.ability[1] + ".png'>" : "<div></div>"}
                </div>
            </div>
